...
```{R}
#We can apply the Bonferroni correction by dividing our original p-value threshold by the number of tests performed.
...
There are 0 genes that are classified as differentially expressed using the p-value of 7.320644e-06 obtained from controlling the Family Wise Error Rate.
...
There are 0 genes that are classified as differentially expressed using the p-value of 7.320644e-06 obtained from controlling the False Discovery Rate.
...
There are 670 genes that are classified as differentially expressed using the p-value of 0.05 obtained from controlling the Per-Comparison Error Rate.
...
$$
= \frac{(0.99)(0.00025)}{(0.99)(0.00025) + (0.01)(0.99975)} = 0.2416
$$
...
The sample mean distribution appears smoothest when increasing n to 1000 versus n = 10 and n = 100. We can include that the distribution of the sample mean resembles a normal/Gaussian distribution and becomes smoother as n increases.
